...
, m_aggregationColorTextureStage(cppassist::make_unique<gloperate::TextureStage>(environment, "TextureStage (Color)"))
, m_aggregationDepthTextureStage(cppassist::make_unique<gloperate::TextureStage>(environment, "TextureStage (Depth)"))
, m_aggregationFramebufferStage(cppassist::make_unique<gloperate::FramebufferStage>(environment, "FramebufferStage (Accumulation)"))
