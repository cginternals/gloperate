...
ShaderCompiler_old::ShaderCompiler_old(const QList<QString> & includePathsAndAliases)
{
    globjects::init();
...
bool ShaderCompiler_old::compile(const QString & shaderFile)
{
...
bool ShaderCompiler_old::compileFile(const std::string & shaderFile, const std::string & extension)
{
