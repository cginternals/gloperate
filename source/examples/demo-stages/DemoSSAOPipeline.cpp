...
, m_colorTextureStage(cppassist::make_unique<gloperate::TextureStage>(environment, "Color Texture"))
, m_depthTextureStage(cppassist::make_unique<gloperate::TextureStage>(environment, "Depth Texture"))
, m_normalTextureStage(cppassist::make_unique<gloperate::TextureStage>(environment, "Normal Texture"))
