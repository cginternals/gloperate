...
#ifdef _MSC_VER
#	define GLOPERATE_ASSIMP_API_EXPORT_DECLARATION __declspec(dllexport)
#	define GLOPERATE_ASSIMP_API_IMPORT_DECLARATION __declspec(dllimport)
#elif __GNUC__
...
#ifdef GLOPERATE_ASSIMP_EXPORTS
#	define GLOPERATE_ASSIMP_API GLOPERATE_ASSIMP_API_EXPORT_DECLARATION
#else
#	define GLOPERATE_ASSIMP_API GLOPERATE_ASSIMP_API_IMPORT_DECLARATION
#endif
#else
