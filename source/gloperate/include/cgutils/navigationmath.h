...
CGUTILS_API glm::vec3 rayPlaneIntersection(
    bool & valid
...
*/
CGUTILS_API glm::vec2 raySquareIntersection(
    const glm::vec2 & point ///< ray points from point to root
,	float length = 1.f);

CGUTILS_API bool insideSquare(
    const glm::vec2 & point ///< ray points from point to root
,	float length = 1.f);

CGUTILS_API glm::vec2 rayCircleIntersection(
    bool & valid
,	const glm::vec2 & origin
,	const glm::vec2 & ray
,	float radius = 1.f);

CGUTILS_API float angle(
    const glm::vec3 & a
,	const glm::vec3 & b);

CGUTILS_API bool boundaryVisible(
    const glm::mat4 & modelViewProjection
,   const AxisAlignedBoundingBox & aabb);

CGUTILS_API bool pointVisible(
    const glm::mat4 & modelViewProjection
...
*/
CGUTILS_API glm::vec3 cameraWithPointInView(
    const glm::vec3 & eye
,	const glm::vec3 & center
,	const glm::vec3 & up
...
CGUTILS_API float distanceToClosestPoint(
    const glm::vec3 & camera
,	const glm::vec3 & center
,	const glm::vec3 & point);
