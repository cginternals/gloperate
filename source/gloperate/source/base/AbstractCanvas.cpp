...
void AbstractCanvas::exportVideo(std::string filename, std::string format, std::string codec, int width, int height, int fps, int seconds, std::string backend)
{
    ...
    m_videoExporter->setTarget(this, filename, format, codec, width, height, fps, seconds);
