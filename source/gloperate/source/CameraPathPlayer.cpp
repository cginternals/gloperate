#include <cgutils/CameraPathPlayer.h>
...
#include <cgutils/math/BezierCurve.h>
...
void CameraPathPlayer::createVao()
{
    ...
    StringTemplate* vertexShaderSource = new cgutils::StringTemplate(new glo::StaticStringSource(vertexSource));
    StringTemplate* fragmentShaderSource = new cgutils::StringTemplate(new glo::StaticStringSource(fragmentSource));
