#include <cgutils/ScreenAlignedQuad.h>
...
#include <cgutils/StringTemplate.h>
...
,   m_samplerIndex(0)
{
    ...
    cgutils::StringTemplate* vertexShaderSource = new cgutils::StringTemplate(new StaticStringSource(s_defaultVertexShaderSource));
    cgutils::StringTemplate* fragmentShaderSource = new cgutils::StringTemplate(new StaticStringSource(s_defaultFagmentShaderSource));
