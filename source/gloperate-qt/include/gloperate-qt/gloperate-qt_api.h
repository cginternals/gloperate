...
#ifdef _MSC_VER
#	define GLOPERATE_QT_API_EXPORT_DECLARATION __declspec(dllexport)
#	define GLOPERATE_QT_API_IMPORT_DECLARATION __declspec(dllimport)
#elif __GNUC__
...
#ifndef GLOPERATE_QT_STATIC
#ifdef GLOPERATE_QT_EXPORTS
#	define GLOPERATE_QT_API GLOPERATE_QT_API_EXPORT_DECLARATION
#else
#	define GLOPERATE_QT_API GLOPERATE_QT_API_IMPORT_DECLARATION
#endif
#else
#	define GLOPERATE_QT_API
#endif
