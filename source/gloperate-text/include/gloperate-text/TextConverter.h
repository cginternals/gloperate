...
public:
    ...
    static void encode(const char * input, ssize_t size, Encoding encoding, std::u32string & output);
    ...
    static void decode(const std::u32string & input, const char * & output, ssize_t size, Encoding encoding);
