...
#ifdef _MSC_VER
#    define GLOPERATE_QTWIDGETS_API_EXPORT_DECLARATION __declspec(dllexport)
#    define GLOPERATE_QTWIDGETS_API_IMPORT_DECLARATION __declspec(dllimport)
#elif __GNUC__
...
#else
#    define GLOPERATE_QTWIDGETS_API GLOPERATE_QTWIDGETS_API_IMPORT_DECLARATION
#endif
#else
#    define GLOPERATE_QTWIDGETS_API
#endif
