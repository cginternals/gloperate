...
#ifdef _MSC_VER
#    define GLOPERATE_GLFW_API_EXPORT_DECLARATION __declspec(dllexport)
#    define GLOPERATE_GLFW_API_IMPORT_DECLARATION __declspec(dllimport)
#elif __GNUC__
...
#else
#    define GLOPERATE_GLFW_API GLOPERATE_GLFW_API_IMPORT_DECLARATION
#endif
#else
